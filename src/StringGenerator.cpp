...
namespace bin2cpp
{
  ...
  bin2cpp::ErrorCodes StringGenerator::createCppEmbeddedFile(const char * iInputFilename, const char * iOutputFolder, const char * iHeaderFilename, const char * iFunctionIdentifier, size_t iChunkSize, bool iOverrideExisting)
  {
    ...
    //create Header file
    bin2cpp::ErrorCodes headerResult = bin2cpp::StringGeneratorUtils::createHeaderEmbededFile(headerPath.c_str(), functionIdentifier.c_str());
    ...
    //Build function 
    std::string getterFunctionName = bin2cpp::StringGeneratorUtils::getGetterFunctionName(functionIdentifier.c_str());
